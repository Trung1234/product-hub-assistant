...
# API Credentials & Configs (Printway 9router API)
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")
OPENAI_API_BASE = os.getenv("OPENAI_API_BASE", "https://9router.printway.io/v1")
MODEL_NAME = os.getenv("MODEL_NAME", "cx/gpt-5.5")
